...
const getPoolXCardsCache = unstable_cache(
    async (id: PoolId) => await fetchPoolXCards(id, { outside: true }),
    ["published-pool-x-cards-outside"],
    {
        tags: ["published-pool"],
    },
);

const OutsidePage = async ({ params }: Props) => {
    ...
    return (
        <div className="space-y-6">
            <PageHeader title={`EDH Cube v${current.version} / その他カード`} />
